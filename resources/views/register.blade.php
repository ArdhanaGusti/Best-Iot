                            ...
                            <form class="user" action="/auth/register" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="first" class="form-control form-control-user @error('first') is-invalid @enderror" id="exampleFirstName"
                                            placeholder="First Name" value="{{old('first')}}">
                                        @error('first')
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="last" class="form-control form-control-user @error('last') is-invalid @enderror" id="exampleLastName"
                                            placeholder="Last Name" value="{{old('last')}}">
                                        @error('first')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
